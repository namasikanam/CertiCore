...
$(O)/%.ll: %.c
	$(Q)$(MKDIR_P) $(@D)
	@echo + llvm $@
	$(QUIET_CC)$(LLVM_CC) -o $@ -mno-sse -S -emit-llvm -fno-discard-value-names $(UBSAN_CFLAGS) -Wno-unused-command-line-argument $(LLVM_IFLAGS) $(filter-out -g,$(BASE_CFLAGS)) $(CONFIG_CFLAGS) -DCONFIG_VERIFICATION_LLVM -c $<
